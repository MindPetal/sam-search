...
def formatted_results():
    return (f'\n\n\n\n**{date.today().strftime("%A, %m/%d/%Y")}.**'
            ...
            + '\n\n**Agency:** Air Force'
            + '\n\n**Date:** 02/25/2024 | **Due:** 03/25/2024 - 04:00PM America/New_York'
            ...
            + '\n\n**Agency:** Energy'
            + '\n\n**Date:** 02/25/2024 | **Due:** 03/12/2024 - 11:59PM America/New_York'
...
def test_search(mocker):
    ...
    assert api_response.to_dict()['value'] == search.search(api_client, 'abcd', 
...
def test_format_date_due_date():
    ...
    assert '03/25/2024 - 04:00PM America/New_York' == search.format_date(due_date)

...
class MsApi(object):
    ...
    def authn_post(self, **kwargs):
        """Authenticates to Microsoft and returns OAuth token.
        ...
        >>> thread = api.authn_post(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.authn_post_with_http_info(**kwargs)
        else:
            (data) = self.authn_post_with_http_info(**kwargs)
            return data

    def authn_post_with_http_info(self, **kwargs):
        """Authenticates to Microsoft and returns OAuth token.
    ...
    def teams_post(self, **kwargs):
        ...
        OAuth required scopes: https://graph.microsoft.com/.default
        Makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, pass async_req=True
